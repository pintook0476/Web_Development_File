...
var uploadProductDetails = require("./routes/uploadProductDetails");
var uploadResource = require("./routes/uploadFile")
...
app.use("/upload/productDetails", uploadProductDetails);
app.use("/upload/resourece", uploadResource);
